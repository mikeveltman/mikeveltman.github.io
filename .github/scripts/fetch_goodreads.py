...
def parse_books(xml_bytes):
    ...
    # ElementTree does not handle CDATA specially — it gives us the text content directly
    ...
    for item in channel.findall("item"):
        ...
        # Goodreads sometimes puts "Title by Author" in the <title> tag
...
def main():
    ...
    # user_read_at format: "Thu Jan 01 00:00:00 -0800 2026"
    try:
        xml = fetch(
            f"https://www.goodreads.com/review/list_rss/{USER_ID}"
